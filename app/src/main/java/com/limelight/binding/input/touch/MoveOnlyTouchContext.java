...
public class MoveOnlyTouchContext implements TouchContext {
    ...
    public MoveOnlyTouchContext(NvConnection conn, int actionIndex,
    ...
    private synchronized void startDragTimer() {
        ...
        dragTimer.schedule(new TimerTask() {
            @Override
            public void run() {
                synchronized (MoveOnlyTouchContext.this) {
    ...
    public boolean touchMoveEvent(int eventX, int eventY, long eventTime) {
        if (eventX != lastTouchX || eventY != lastTouchY) {
            ...
            if (actionIndex == 0) {
                ...
                deltaX = deltaX * Game.getInstance().scrollerSpeed / 5;
                deltaY = deltaY * Game.getInstance().scrollerSpeed / 5;
