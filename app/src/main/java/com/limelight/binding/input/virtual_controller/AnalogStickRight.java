 ...
 */
public class AnalogStickRight extends VirtualControllerElement {
    ...
    private int iconButtonLeft = R.mipmap.ic_stick_button_right;
    private int iconButtonSelectedLeft = R.mipmap.ic_stick_button_right_pressed;
    ...
    public AnalogStickRight(VirtualController controller, Context context, int elementId) {
