...
public class HXSSwitchView extends View {

    private final int DEFAULT_COLOR_ON = 0xff53d769;
    private final int DEFAULT_COLOR_OFF = 0x88e3e3e3;
    ...
    public HXSSwitchView(Context context) {
        this(context, null);
    }

    public HXSSwitchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(HXSSwitchView switchView, boolean isChecked);
    }
